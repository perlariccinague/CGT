...
<script>
    ...
    const mandatory_fields = ['360','361','362','363','364','365','366','367','368','528'];
    ...
    allImpressionsLinks.forEach(link => {
        link.addEventListener('click', function() {
            document.getElementById('article-122').querySelector('.toggler').click();
        })
    });
    ...
    allPrizesLinks.forEach(link => {
        link.addEventListener('click', function() {
            document.getElementById('article-42').querySelector('.toggler').click();
        })
    });
    ...
    allInformationLink.forEach(link => {
        link.addEventListener('click', function() {
            document.getElementById('article-72').querySelector('.toggler').click();
        })
    });
